...
public class Ejer1Angulos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonAtras.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                startActivity(new Intent(Ejer1Angulos.this,Angulos.class));
            }
        });
        ...
        respuestaCorrecta.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                mp.start();
                startActivity(new Intent(Ejer1Angulos.this,PopUp_Correcto.class));
            }
        });
        ...
        fallo1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                mp2.start();
                startActivity(new Intent(Ejer1Angulos.this,PopUp_Incorrecto.class));
            }
        });
