...
public class Ejer10Mult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonAtras.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                startActivity(new Intent(Ejer10Mult.this,Multiplicaciones.class));
            }
        });
        ...
        respuestaCorrecta.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                mp.start();
                startActivity(new Intent(Ejer10Mult.this,PopUp_Correcto.class));
            }
        });
        ...
        fallo1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                mp2.start();
                startActivity(new Intent(Ejer10Mult.this,PopUp_Incorrecto.class));
            }
        });
