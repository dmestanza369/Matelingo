...
public class Ejer5Mult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonAtras.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                startActivity(new Intent(Ejer5Mult.this,Multiplicaciones.class));
            }
        });
        ...
        respuestaCorrecta.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                mp.start();
                startActivity(new Intent(Ejer5Mult.this,PopUp_Correcto.class));
            }
        });
        ...
        fallo1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                mp2.start();
                startActivity(new Intent(Ejer5Mult.this,PopUp_Incorrecto.class));
            }
        });
